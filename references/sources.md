...
> Tất cả nguồn đã được sử dụng trong các reference files. Ngày access: 05/05/2026.

## Phân Loại Confidence

| Level | Ý nghĩa | Khi nào dùng |
|-------|---------|-------------|
| 🟢 HIGH | Nguồn chính thống, luật/nghị định | Trích dẫn trực tiếp |
| 🟡 MEDIUM | Nguồn tư vấn thuế uy tín | Tham khảo, cần cross-check |
| 🔴 LOW | Cộng đồng, forum, thảo luận | CHỈ dùng cho FAQ, KHÔNG dùng cho số liệu |

## Nguồn Chính Thống (🟢 HIGH)

| Nguồn | URL đầy đủ | Nội dung chính |
|-------|-----------|---------------|
| Chính phủ VN | https://chinhphu.vn | NQ 110/2025, Luật 109/2025/QH15 |
| Tổng cục Thuế | https://gdt.gov.vn | Hướng dẫn quyết toán, eTax, mẫu biểu |
| Cổng thuế cá nhân | https://canhan.gdt.gov.vn | Kê khai online |
| Thư viện Pháp luật | https://thuvienphapluat.vn | Tra cứu luật gốc, nghị định, thông tư |
| Luật Việt Nam | https://luatvietnam.vn | Phân tích quy định mới, so sánh |
| Báo Chính phủ | https://baochinhphu.vn | Thông tin chính sách chính thống |

## Nguồn Tư Vấn Thuế (🟡 MEDIUM)

| Nguồn | URL đầy đủ | Nội dung chính |
|-------|-----------|---------------|
| Kế toán Thiên Ưng | https://ketoanthienung.net | Hướng dẫn kê khai chi tiết |
| Kế toán An Pha | https://ketoananpha.vn | SOP quyết toán, cam kết 08/CK |
| THTax | https://thtax.vn | Hướng dẫn freelancer/KOL |
| Einvoice | https://einvoice.vn | Biểu thuế lũy tiến mới |
| MISA | https://misa.vn | eTax Mobile hướng dẫn |
| MeInvoice | https://meinvoice.vn | Mẫu biểu, hóa đơn điện tử |

## Nguồn Truyền Thông (🟡 MEDIUM)

| Nguồn | URL đầy đủ | Nội dung chính |
|-------|-----------|---------------|
| Tuổi Trẻ | https://tuoitre.vn | Hướng dẫn eTax Mobile step-by-step |
| VnExpress | https://vnexpress.net | Sàn TMĐT khấu trừ thuế thay |
| Thanh Niên | https://thanhnien.vn | Ngưỡng doanh thu mới |
| Tiền Phong | https://tienphong.vn | Thuế bán hàng online |
| Báo Mới | https://baomoi.com | Tổng hợp tin thuế |
...
## Công Văn Hướng Dẫn (🟡 MEDIUM)

| Văn bản | Nội dung | Ngày | Cơ quan |
|---------|---------|------|--------|
